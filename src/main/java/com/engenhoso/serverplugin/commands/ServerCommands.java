...
public class ServerCommands implements CommandExecutor, TabCompleter {
    ...
    public ServerCommands(DimensionLockModule dimensionLockModule) {
    ...
    private boolean executarLock(CommandSender sender, String[] args) {
        ...
        try {
            dimensionLockModule.travar(dimensao, quantidade, args[2]);

            String nome = dimensionLockModule.getNomeExibicao(dimensao);
    ...
    private boolean executarUnlock(CommandSender sender, String[] args) {
        ...
        try {
            dimensionLockModule.destravar(dimensao);
